...
{
    FUN_1403a71f0(DAT_140c65898,*(undefined4 *)(param_1 + 8),*param_2,1);
    return 0;
}
...
{
    FUN_14047a140();
    FUN_1403a71f0(DAT_140c65898,*(undefined4 *)(param_1 + 8),0x25);
    return 0;
}
...

{
    ...
    if (((lVar3 != 0) && (*(longlong *)(lVar3 + 0x18) != 0)) &&
        ...
        FUN_1400ea3e0(*(undefined8 *)(DAT_140c65898 + 0x7340),"InvokeCraftingWindow",&DAT_1409e9f14,
                      *(undefined4 *)(lVar3 + 8));
        FUN_1403a71f0(lVar2,*(undefined4 *)(lVar3 + 8),0x2c);
        return 0;
    }
    return 3;
}
